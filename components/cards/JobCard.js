...
const JobCard = ({ job, handleClick, isApplied }) => {
  return (
    <div
      ...
      className=" flex flex-col justify-between bg-g-700 rounded-[10px] overflow-hidden shadow-2xl p-4 border border-g-500 hover:border-primary transition-colors cursor-pointer h-full shrink-0"
    >
      <div>
